...
class PropOpsService:
    ...
    def list_compliance_tasks(
        ...
        query = "SELECT * FROM compliance_tasks"
        params: Iterable[object] = ()
    ...
    def update_compliance_status(self, task_id: int, status: str) -> ComplianceTask:
        with get_connection(self.db_path) as conn:
            cursor = conn.execute(
                """
